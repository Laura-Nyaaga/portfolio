...
const SkillIcon = ({ name, icon }) => {
  return (
    <div className="group relative transform hover:scale-110 transition-all duration-300 animate-float">
      <div className="w-24 h-24 bg-gray-900 rounded-lg rotate-45 overflow-hidden border-2 border-gray-700 
      ...
      <p className="text-center mt-4 text-gray-300 opacity-0 group-hover:opacity-100 
